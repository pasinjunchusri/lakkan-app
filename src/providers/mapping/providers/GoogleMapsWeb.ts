        ...
        if (apiLoaded) {
            if (this.map == null) {
                ...
                if (mapCanvas != null) {
                    ...
                    mapCanvas.style.height = IonicUtil.getClientHeight().toString();
                    this.logging.log("Defaulted map height to " + IonicUtil.getClientHeight());
                    //create map
                    var mapOptions = {
                        zoom                 : 10,
                ...
                if (poiList[i].AddressInfo != null) {
                    if (poiList[i].AddressInfo.Latitude != null && poiList[i].AddressInfo.Longitude != null) {
                        ...
                        if (addMarker) {
                            ...
                            iconURL = IonicUtil.getIconForPOI(poi);
                            ...
                            google.maps.event.addListener(newMarker, 'click', function () {
                                ...
                                if (console) {
                                    console.log("POI clicked:" + this.poi.ID);
                                }
