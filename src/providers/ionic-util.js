...
var IonicUtil = (function () {
    function IonicUtil(platform, loadingCtrl, toastCtrl, translateService) {
        this.platform = platform;
        this.loadingCtrl = loadingCtrl;
        this.toastCtrl = toastCtrl;
        this.translateService = translateService;
        this._cordova = this.platform.is('cordova') ? true : false;
        console.log('cordova', this._cordova);
    }
    ...
    IonicUtil.prototype.translate = function (text) {
        ...
        return new Promise(function (resolve) {
            _this.translateService.get(text).subscribe(function (res) { return resolve; });
        });
    };
