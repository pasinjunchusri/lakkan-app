...
var GalleryComment = (function () {
    function GalleryComment() {
        ...
        this.ParseObject = Parse.Object.extend('GalleryComment', {});
    ...
    GalleryComment.prototype.create = function (item) {
        var ParseObjectRow = new this.ParseObject();
        return ParseObjectRow.save(item);
    };
    GalleryComment.prototype.put = function (item) {
    ...
    GalleryComment.prototype.destroy = function (item) {
        return item.destroy();
    };
    GalleryComment = __decorate([
        core_1.Injectable()
    ], GalleryComment);
    return GalleryComment;
}());
exports.GalleryComment = GalleryComment;
